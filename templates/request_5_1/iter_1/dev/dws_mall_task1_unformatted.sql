...
select
    ...
    ,non_welfare_exchange_orders_ratio - lag(non_welfare_exchange_orders_ratio) over(partition by func_name order by dt) as non_welfare_exchange_orders_ratio_diff
from
B
order by dt desc
