...
config_file = '_config_xianmo.xlsx'
sheet_name = 'Sheet1'
MY_TABLE_NAME = 'guozizhun.config_xianmo'
sql_file1 = '_config_xianmo_1_drop.sql'
sql_file2 = '_config_xianmo_2_create.sql'
sql_file3 = '_config_xianmo_3_insert.sql'
