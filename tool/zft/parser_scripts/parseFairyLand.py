...
sheet_name = 'config_fairy_level'
MY_TABLE_NAME = 'guozizhun.config_fairy_land'
sql_file1 = 'config_fairy_land_1_drop.sql'
sql_file2 = 'config_fairy_land_2_create.sql'
sql_file3 = 'config_fairy_land_3_insert.sql'
